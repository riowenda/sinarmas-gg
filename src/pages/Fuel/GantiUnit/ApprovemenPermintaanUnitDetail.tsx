...
const ApprovementPermintaanUnitDetail: React.FC = () => {
    ...
    const loadDataPref = () => {
        ...
        // const dataId = 'c781bc1b-302d-4251-8f04-5c559343cb91';
        // @ts-ignore
        setGetId(dataId);
        // @ts-ignore
    ...
    const handleSetuju = async () => {
        const url = BaseAPI() + API_URI + PEGAWAI_UNIT_CRUD_URI + PEGAWAI_UNIT_APPROVED_URI;
...
export default ApprovementPermintaanUnitDetail;
