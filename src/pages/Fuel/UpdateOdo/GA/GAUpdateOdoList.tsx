...
const GAUpdateOdoList: React.FC = () => {
    ...
    const loadDataPermintaan = (token: string, s: any) => {
        let status = s != null && s !== "" ? s : "PROPOSED";
    ...
    const btnDetailReqFuel = (id: any) => {
        let path = "/fuel/ga-detail-perbaikan-odo/";
        history.push({
            pathname: path + id,
            state: { detail: id }
        });
    ...
    return (
        <IonPage>
            ...
            {/* end Header */}
            <div hidden className="bg-white px-3 pt-4 divide-y divide-gray-300">
...
export default GAUpdateOdoList;
