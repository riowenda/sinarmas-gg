    ...
    <IonPage>
      <IonContent fullscreen>
        ...
        <div className="bg-red-700">
          ...
          <ListHeader title={"Rating Pesanan"} isReplace={false} />

          <div className="bg-white">
          {/*<div className="bg-white rounded-t-3xl px-2 pt-2 pb-6">*/}
            <div className="p-6">

              <label htmlFor="visitorType" className="block mt-3 text-sm text-gray-900 font-bold">Rasa</label>
              <div className="flex">
                <StarIcon className="w-7 fill-purple-700" />
                <StarIcon className="w-7 fill-purple-700" />
                <StarIcon className="w-7 fill-purple-700" />
                <StarIcon className="w-7 fill-gray-300" />
                <StarIcon className="w-7 fill-gray-300" />
              </div>

              <label htmlFor="visitorType" className="block mt-3 text-sm text-gray-900 font-bold">Kebersihan</label>
              <div className="flex">
                <StarIcon className="w-7 fill-purple-700" />
                <StarIcon className="w-7 fill-purple-700" />
                <StarIcon className="w-7 fill-purple-700" />
              ...
              <label htmlFor="visitorType" className="block mt-3 text-sm text-gray-900 font-bold">Pelayanan</label>
              <div className="flex">
                <StarIcon className="w-7 fill-purple-700" />
                <StarIcon className="w-7 fill-purple-700" />
                <StarIcon className="w-7 fill-purple-700" />
                ...
                {file ?
                  ...
                  <div className="rounded-md border-2 border-dashed border-gray-300 py-10">
                      <>
                        ...
                        <p className="text-xs text-center text-gray-500">Upload Bukti</p>
                      </>
                  </div>
                }
              </div>
              ...
              <div className="min-w-0">
                <p className="text-sm text-gray-900 py-1 mt-3">Comment</p>
