          ...
          {/*<div className="bg-white rounded-t-3xl px-2 pt-2 pb-6">*/}
            <div className="p-6">
              <div className="border border-gray-300 rounded-md p-2 mb-2">
                <div className="py-1 text-gray-900 text-center">
                  Selamat Datang di Kantin Angsana <br />
              ...
              <div className="my-2 text-gray-900 text-center text-red-500">
                Saat ini anda tercatat penerima jatah makanan packmeal di lokasi POS 1
              </div>

              <label htmlFor="visitorType" className="block mt-3 text-sm text-gray-900">Menu yang tersedia :</label>
